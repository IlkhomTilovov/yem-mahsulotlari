...
import { Loader2, LayoutDashboard, Package, Users, MessageSquare, LogOut, Settings, FolderTree, PanelTop, FileText, Languages } from "lucide-react";
...
const NAV: NavItem[] = [
  ...
  { to: "/admin/pages", label: "CMS Sahifalar", icon: FileText, roles: ["super_admin", "content_manager"] },
  ...
  { to: "/admin/translations", label: "Sayt matnlari", icon: Languages, roles: ["super_admin", "content_manager"] },
