...
const T = {
  ...
  RU: {
    ...
    cta: { quote: "Запросить цену", catalog: "Скачать каталог", application: "Оставить заявку", products: "Продукты", startPL: "Начать Private Label проект", sendInquiry: "Отправить запрос", reqQuote: "Запросить цену", reqSample: "Запросить образец" },
    hero: {
  ...
  EN: {
    ...
    cta: { quote: "Request a Quote", catalog: "Download Catalog", application: "Leave a Request", products: "Products", startPL: "Start a Private Label Project", sendInquiry: "Send Inquiry", reqQuote: "Request Quote", reqSample: "Request Sample" },
    hero: {
